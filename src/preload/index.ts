...
import { exposeWindow } from '@carapace/shell/ipc'
...
// Carapace window-control bridge (window.carapaceWindow) — backs the frameless TopBar's controls.
exposeWindow(contextBridge, ipcRenderer)
